module sigs.k8s.io/kueue/perf-tests/clusterloader2
...
require (
	k8s.io/klog v1.0.0
	k8s.io/perf-tests/clusterloader2 v0.0.0-20221021094750-196359f19272
)
...
require (
	...
	k8s.io/kubelet v0.22.15 // indirect
	k8s.io/kubernetes v1.22.15 // indirect
